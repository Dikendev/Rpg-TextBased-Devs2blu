...
public class FrameAto201 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameAto201 frame = new FrameAto201();
	...
	public FrameAto201() {
		...
		imagem.setIcon(new ImageIcon(FrameAto201.class.getResource("/Images/vulcao.jpg")));
