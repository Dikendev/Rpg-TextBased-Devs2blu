...
public class Historia {
	...
	public static void historiaDoRpg() {
	...
	public static void bruxoCacador() {
		GameLogic.telaPontilhada(50);
	...
	public static void magoCinzento() {
		GameLogic.telaPontilhada(50);
		System.out.println("Historia");
		GameLogic.telaPontilhada(50);
	...
	public static void deathKnight() {
		GameLogic.telaPontilhada(50);
		System.out.println("Historia");
		GameLogic.telaPontilhada(50);
		System.out.println("Ai sim");
	...
	public static void orcGuerreiro() {
	...
	public static void dragaoCabeca() {
		GameLogic.limparConsole();
		GameLogic.telaPontilhada(50);
		System.out.println(
	...
	public static void capivaraZumbi() {
		GameLogic.limparConsole();
		GameLogic.telaPontilhada(50);
		System.out.println(
	...
	public static void velhoDoSaco() {
		GameLogic.limparConsole();
		GameLogic.telaPontilhada(50);
		System.out.println(
