...
public class ChefaoRagnaros extends Vilao{
	...
	public int ataqueBasico() {
		System.out.printf("|%-91s|%n", "Ragnaros bate seu Martelo de Fogo no chão, dispersando uma onda de fogo causando "+LogicaJogo.VermelhoClaro+"55 de dano!"+LogicaJogo.Reseta);
	...
	public int ataqueBasico2() {
		System.out.printf("|%-91s|%n", "Ragnaros sopra seu Fogo Infernal na sua direção, causando "+LogicaJogo.VermelhoClaro+"60 de dano!"+LogicaJogo.Reseta);
	...
	public int ataqueEspecial() {
		System.out.printf("|%-91s|%n", "Ragnaros invoca elementais de fogo, que atiram em sua direção causando "+LogicaJogo.VermelhoClaro+"70 de dano!"+LogicaJogo.Reseta);
		System.out.printf("|%-91s|%n", LogicaJogo.Vermelho+"Dano: 70"+LogicaJogo.Reseta);
		return 70;
	}
