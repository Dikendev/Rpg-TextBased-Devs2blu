...
public class ChefaoQuimera extends Vilao{
	...
	public void recebeDano(int dano) {
		...
		if(this.getVida() <= 0) {
			System.out.printf("|%-91s|%n", "Você deferiu um golpe fatal,"+LogicaJogo.VermelhoFun+" Quimera morreu!"+LogicaJogo.Reseta);
		}else {
			System.out.printf("|%-91s|%n", "Quimera recebeu dano, a vida dele é: " + LogicaJogo.Verde + this.getVida() + LogicaJogo.Reseta);			
		}
	}
